...
public class C04_TekSayfadaFarkliTestler {
    ...
    @Test
    public void test02(){
        // amazonm sayfasinda java icin arama yapip sonuc yazisinin nutella icerdigini test edelim
    ...
    @Test
    public void test03(){
        // amazonm sayfasinda ali icin arama yapip sonuc yazisinin nutella icerdigini test edelim
        aramaKutusu=driver.findElement(By.id("twotabsearchtextbox"));
        aramaKutusu.clear();
